...
\begin{enumerate}
    ...
    \item \textbf{Research question}:
        \begin{itemize}
            \item \textbf{Architecture search:} Taking inspiration from classical neural nets, a quantum layer was defined based on the number of qubits~\cite{lockwood2020:reinforcementlearningquantumvariational}. A schematic of the same is shown in figure \ref{fig:Architecture_of_qnn}. A search was conducted on the number of qubits and the number of quantum layers to find the best architecture.
